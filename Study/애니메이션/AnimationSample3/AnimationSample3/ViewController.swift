...
class ViewController: UIViewController {
    ...
    private func setupFirstMenu() {
        for i in (0..<UI.menuCount) {
            ...
            if i == 0 {
                ...
                button.addTarget(self, action: #selector(self.firstMenuDidTap(_:)), for: .touchUpInside)
            }
        }
    ...
    private func setupSecondMenu() {
        for i in (0..<UI.menuCount) {
            ...
            if i == 0 {
                button.transform = .identity
                button.addTarget(self, action: #selector(self.secondMenuDidTap(_:)), for: .touchUpInside)
            }
        }
